      ...
      <div className="ptb-100">
        <div className="container">
          <div className={styles.privacyPolicyContent}>
            <p>
              <i>This Privacy Policy was last updated on April 30, 2023.</i>
            </p>
            <h3>
              <span></span> Our website
            </h3>
            <blockquote className="blockquote">
              <p>Our website address is: http://saasgo.in</p>
              <p>
                ...
                from third-party platforms you connect with saasGO. We also
            ...
            <h3>
              <span></span> Welcome to saasGO!
            </h3>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of saasGO's Website, located at www.saasgo.in.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use saasGO if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing saasGO, you agreed to
              use cookies in agreement with the saasGO's Privacy Policy.
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, saasGO and/or its licensors own the
              intellectual property rights for all material on saasGO. All
              intellectual property rights are reserved. You may access this
              from saasGO for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from saasGO</li>
              <li>Sell, rent or sub-license material from saasGO</li>
              <li>Reproduce, duplicate or copy material from saasGO</li>
              <li>Redistribute content from saasGO</li>
            </ul>
            <p>
            ...
            <p>
              ...
              saasGO does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of saasGO,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, saasGO
            ...
            <p>
              saasGO reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant saasGO a non-exclusive license to use, reproduce,
              edit and authorize others to use, reproduce and edit any of your
              Comments in any and all forms, formats or media.
            </p>
            <h3>
              <span></span>Hyperlinking to our Content
            </h3>
            <p>
            ...
            <p>
              ...
              saasGO; and (d) the link is in the context of general resource
              information.
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to saasGO. Please include your name, your
            ...
            <p>
              No use of saasGO's logo or other artwork will be allowed for
